...
const TR = {
    ...
    ctaTitle: "Sıradaki Adım Ne?",
    ctaText: "Sonuçlarınız iyileştirme potansiyeli olduğunu gösteriyor. Kişiselleştirilmiş koçluk, bu rakamları yağ kaybı ve kas kazanımı için etkili bir eylem planına dönüştürmenize yardımcı olur.",
    ctaButton: "Hedeflerinizi Görüşün",
    ...
    // Adımlar
    step1Title: "Biyolojik Cinsiyetinizi Seçin",
    ...
    errorRange: (min: string, max: string) => `Aralık: ${min}-${max}`, // Dinamik hata mesajı
    ...
    // Yöntem Bilgileri (METHOD_INFO için anahtarlar aynı kalmalı)
    methodNotes: {
    ...
    // Kısaltmalar (ABBREVIATIONS için anahtarlar aynı kalmalı)
    abbreviations: {
        "BF%": "Vücut Yağ Yüzdesi", "BMI": "Vücut Kitle İndeksi",
    ...
    // Kategori Sonuçları (getBfCategory için anahtarlar aynı kalmalı)
    categoryNames: {
        "Contest Prep": "Yarışma Hazırlığı",
        "Athletic": "Atletik",
        "Average": "Ortalama",
    ...
    // Diğer
    bmiValueTitle: "VKİ Değeri",
    averageBfTitle: "Ort. VY%",
    bmiValueTooltip: "Vücut Kitle İndeksi (Kilo/Boy²)",
    averageBfTooltip: "Hesaplanan VY% yöntemlerinin ortalaması",
};
 ...
 * Styling Palette
 ***************************/
const PALETTE = { BACKGROUND: "#0d1117", CARD_BACKGROUND: "#161b22", TEXT_PRIMARY: "#c9d1d9", TEXT_SECONDARY: "#8b949e", ACCENT: "#58a6ff", ACCENT_HOVER: "#79c0ff", GRID_COLOR: "#30363d", BORDER_COLOR: "#30363d", ERROR_COLOR: "#f85149", INFO_ICON_COLOR: "#8b949e", SUCCESS_COLOR: "#3fb950", WARNING_COLOR: "#eac54f", CHART_COLORS: ["#58a6ff", "#79c0ff", "#3fb950", "#a371f7", "#f85149", "#db6d28", "#eac54f"] };
