...
import { ArrowLeft, ArrowRight, Loader2, Mail, Info, Instagram } from 'lucide-react'; // Instagram ikonu eklendi
...
const TR = {
    ...
    // Adımlar
    step1Title: "Cinsiyetinizi Seçin", // Güncellendi
    ...
    // Kısaltmalar (Güncellendi)
    abbreviations: {
        "VY%": "Vücut Yağ Yüzdesi", "VKİ": "Vücut Kitle İndeksi", // BMI -> VKİ
...
export default function BodyFatEstimatorWizard() {
  ...
  return (
    <div className="mx-auto max-w-5xl p-6 sm:p-10 lg:p-14 rounded-2xl shadow-xl font-sans min-h-[calc(100vh-5rem)] flex flex-col relative" /* Adjusted min-h, removed justify-center, added pb for button space */ style={{ background: PALETTE.BACKGROUND, color: PALETTE.TEXT_PRIMARY }}>
